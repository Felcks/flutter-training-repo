...
import 'package:clean_architeture_tdd/core/error/failure.dart';
import 'package:clean_architeture_tdd/core/network/network_info.dart';
import 'package:clean_architeture_tdd/features/number_trivia/data/data_sources/number_trivia_local_data_source.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    group('device is online', () {
      ...
      test(
        'should return remote ServerFailure when the call to remote data source is unsuccessful',
        () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any))
